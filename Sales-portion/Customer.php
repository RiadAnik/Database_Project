...
<form action="SalesSection.php" method="POST"><input type="submit" class="cat"style="font-face: 'Comic Sans MS'; font-size: smaller; color: teal; background-color: #FFFFC0; border: 1pt ridge lightgrey" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Go Back&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"></form></div>
        ...
        table#t01 th	{
            ...
            <form action="#" method="POST"><br>
                 First name:<input type="text" style="font-face: 'Comic Sans MS'; font-size: small; color: teal; background-color:#E6E6FA ; border: 1pt ridge lightgrey"name="fname"><br><br>
                <div class="sub"><input type="submit" name="submit"style="font-face: 'Comic Sans MS';cursor:pointer; font-size: medium; color: white; background-color: #667A44; border: 1pt ridge lightgrey" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Search&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"></div>
                <br>
            </form>
                      <form action="addCustomer.php" method="POST"><br>

               <div class="sub"><input type="submit" style="font-face: 'Comic Sans MS';cursor:pointer; font-size: medium; cursor:pointer;color: white; background-color: #667A44; border: 1pt ridge lightgrey" value="&nbsp;&nbsp;&nbsp;&nbsp;Add New Customer&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"></div>
    <br><br>
            </form>
...
if(isset($_REQUEST['submit'])){
    ...
    {
    $sql=" SELECT `C_Fname`,`C_Lname`,`C_email`,`C_phone` FROM project.`customer` WHERE `D_id`='1' AND `C_Fname` like '$name%' ";
    $q=mysql_query($sql);
    }
}
else{
    $sql="SELECT `C_Fname`,`C_Lname`,`C_email`,`C_phone` FROM project.`customer` WHERE `D_id`='1'";
    $q=mysql_query($sql);
}
