...
<html>
    ...
    <body>
        ...
        <nav>
            <div class="submit">
                <form action="order.php" method="POST"><input type="submit" class="cat"style="font-face: 'Comic Sans MS'; font-size: smaller; color: teal; background-color: #FFFFC0; border: 1pt ridge lightgrey" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Go Back&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"></form>
</div>
...
?>
        ...
        table#t01 th	{
         ...
         <body bgcolor=" #FFFFC0" display: flex>
            <form action="deleteorderhidden.php" method="post">  <div class="sub"> <input type="submit" style="font-face: 'Comic Sans MS';cursor:pointer; font-size: medium; color: white; background-color: #667A44; border: 1pt ridge lightgrey" value="&nbsp;&nbsp;&nbsp;&nbsp;Delete Order&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
                </div>
...
echo "<a class=\"button\"href='deleteorder.php?page=1'>".'|<'."</a> "; // Goto 1st page  

for ($i=1; $i<=$total_pages; $i++) { 
            echo "<a class=\" button\" href='deleteorder.php?page=".$i."'>".$i."</a> "; 
}; 
echo "<a class=\"button\"href='deleteorder.php?page=$total_pages'>".'>|'."</a> "; // Goto last page
?>
        </body>
             </form>
        </section>
