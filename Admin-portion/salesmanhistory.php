...
?>
<?php
    $result = mysql_query("SELECT `S_name`FROM project.`salesman`WHERE `status`='inactive' ORDER BY  `S_id`  ");
?>
...
?>
    ...
    <tbody>
        <form action="activesalesman.php" method="post">
    <?php
